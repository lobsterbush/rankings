...
:root{
  ...
  --q1:#dbe4f0; --q2:#b6c9e0; --q3:#8aa9cb; --q4:#5d88b5;
  --q5:#2f6ba6; --q6:#245685; --q7:#1a4368; --q8:#0d2b4c;
...
.lede{font-size:17.5px;line-height:1.62;color:var(--ink);margin:0 0 10px}
p{margin:0 0 14px}
...
<header class="col">
 <h1>A latent measure of international university standing</h1>
 <p class="byline">Charles Crabtree · Monash University · <span id="dateline"></span></p>
 <p class="tabs"><b>Universities</b> <a href="departments.html">Departments</a>
